...
<Project Type="Project" LVVersion="12008004">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Microfontest" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="GenerateFrequencyTable" Type="Folder">
				<Item Name="SubVi" Type="Folder">
					<Item Name="Array_doppelte_Werte_entfernen.vi" Type="VI" URL="../../generelle VI&apos;s/Array_doppelte_Werte_entfernen.vi"/>
				</Item>
				<Item Name="GenerateFrequencyTable.vi" Type="VI" URL="../GenerateFrequencyTable.vi"/>
			</Item>
			<Item Name="calibrateRefMicro" Type="Folder">
				<Item Name="SubVi" Type="Folder"/>
				<Item Name="calibrateRefMicro.vi" Type="VI" URL="../calibrateRefMicro.vi"/>
			</Item>
			<Item Name="AdjustSpeaker" Type="Folder">
				<Item Name="SubVi" Type="Folder">
					<Item Name="FrequenzPegelKorrigieren.vi" Type="VI" URL="../SubVi/FrequenzPegelKorrigieren.vi"/>
				</Item>
				<Item Name="AdjustSpeaker.vi" Type="VI" URL="../AdjustSpeaker.vi"/>
			</Item>
			<Item Name="FG_Messen" Type="Folder">
				<Item Name="Anheben der Amplitude (SubVi).vi" Type="VI" URL="../Anheben der Amplitude (SubVi).vi"/>
				<Item Name="Frequenzmessung vervielfachen.vi" Type="VI" URL="../Frequenzmessung vervielfachen.vi"/>
				<Item Name="FG_Messen.vi" Type="VI" URL="../FG_Messen.vi"/>
			</Item>
			<Item Name="getMicSensitivity" Type="Folder">
				<Item Name="SubVi" Type="Folder"/>
				<Item Name="getMicSensitivity.vi" Type="VI" URL="../getMicSensitivity.vi"/>
			</Item>
			<Item Name="IEPE_einschalten" Type="Folder">
				<Item Name="IEPE_einschalten.vi" Type="VI" URL="../IEPE_einschalten.vi"/>
			</Item>
			<Item Name="Microfontest.vi" Type="VI" URL="../Microfontest.vi"/>
		</Item>
		<Item Name="SubVi" Type="Folder">
			<Item Name="SteppedSweepChannelConfig.vi" Type="VI" URL="../SteppedSweepChannelConfig.vi"/>
			<Item Name="MyTemplate.vit" Type="VI" URL="../SubVi/MyTemplate.vit"/>
			<Item Name="WF_Collector.vi" Type="VI" URL="../SubVi/WF_Collector.vi"/>
		</Item>
		<Item Name="Type" Type="Folder">
			<Item Name="alt" Type="Folder">
				<Item Name="Peiker_SteppedSweepConfig.ctl" Type="VI" URL="../Peiker_SteppedSweepConfig.ctl"/>
			</Item>
			<Item Name="Peiker_Stepped Sweep Settings.ctl" Type="VI" URL="../Peiker_Stepped Sweep Settings.ctl"/>
		</Item>
		...
		<Item Name="NameYScaleTHD (SubVI).vi" Type="VI" URL="../NameYScaleTHD (SubVI).vi"/>
		<Item Name="NameYScaleRMS (SubVI).vi" Type="VI" URL="../NameYScaleRMS (SubVI).vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="svl_Set Input Coupling and IEPE Excitation (All Ch).vi" Type="VI" URL="/&lt;vilib&gt;/addons/Sound and Vibration/svt_DAQmx/subVIs/svl_Set Input Coupling and IEPE Excitation (All Ch).vi"/>
				<Item Name="svl_Set Input Coupling and IEPE Excitation.vi" Type="VI" URL="/&lt;vilib&gt;/addons/Sound and Vibration/svt_DAQmx/subVIs/svl_Set Input Coupling and IEPE Excitation.vi"/>
			...
			<Item Name="Abgleich_Finetuning.vi" Type="VI" URL="../Abgleich_Finetuning.vi"/>
			<Item Name="check_Coh_Faktor_past_Values.vi" Type="VI" URL="../check_Coh_Faktor_past_Values.vi"/>
			<Item Name="Amplitude_Calculation_for_finetuning.vi" Type="VI" URL="../Amplitude_Calculation_for_finetuning.vi"/>
